...
* **Dynamic Data Architecture**: Automates the rendering of project cards, external client website URLs, and thumbnails by intelligently mapping JSON data (`src/data`) to the UI.
